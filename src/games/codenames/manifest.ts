...
export const manifest: GameManifest = {
  ...
  description: {
    ...
    fa: 'دو تیم برای پیدا کردن کلمات مخفی‌شان روی شبکهٔ ۵×۵ رقابت می‌کنند. هر رئیس‌جاسوس پنهانی کلید را می‌بیند و یک سرنخ تک‌کلمه‌ای می‌دهد. کلمات خودت را حدس بزن، اما حواست به جاسوس مرگبار باشد وگرنه همان‌جا می‌بازی.',
  },
  icon: '🔲',
  color: 'lime',
  category: 'word',
